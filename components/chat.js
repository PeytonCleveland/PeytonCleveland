...
//<div className="w-2.5 h-2.5 animate-ping rounded-full bg-green-400 absolute -left-1 -top-1 opacity-70"></div>
//<div className="w-2.5 h-2.5 rounded-full bg-green-600 absolute -left-1 -top-1"></div>
