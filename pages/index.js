    ...
    <div>
      ...
      <div className="container h-screen flex flex-row items-center">
          ...
          <div className="absolute bottom-10 flex flex-col space-y-2">
            ...
            <div className="flex flex-row space-x-4">
              <a href="https://google.com">
                <Image src="/linkedin.svg" className="w-8 h-8" />
              </a>
              <a href="https://github.com/PeytonCleveland">
                <Image src="/github.svg" className="w-8 h-8" />
              </a>
              <a href="https://google.com">
                <Image src="/slack.svg" className="w-8 h-8" />
              </a>
              <a href="https://discordapp.com/users/646023304087470101">
                <Image src="/discord.svg" className="w-8 h-8" />
              </a>
            </div>
          </div>
        </div>
        <div className="pl-16 mt-2 space-y-3 absolute right-0 h-screen w-2/6 overflow-hidden whitespace-nowrap">
          ...
          <h6 className="text-6xl outlined uppercase font-extrabold tracking-wider text-transparent opacity-0">
            Product Management
          </h6>
